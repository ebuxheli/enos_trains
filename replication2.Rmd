...
```{r}
plot(balance_table, xlab = "Standardized Differences",
     variable.labels = c(statistic = "std.diff",
                         liberal = "Liberal",
                         republican = "Republican",
                         obama.disapprove = "Obama disapprove",
                         ride.everyday = "Ride MBTA every day",
                         voted.2010 = "Vote 2010",
                         romney.voter = "Romney voter",
                         Hispanics.x = "Hispanic threat",
                         age = "Age",
                         residency.new = "Residency year",
                         college = "College",
                         male = "Male",
                         hispanic.new = "Hispanic",
                         white = "White",
                         income.new = "Income"))
```
