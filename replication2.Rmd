...
confed_data <- read.csv("dataverse_files/confederate_face_data.csv")
hisp_data   <- read.csv("dataverse_files/hispanic_face_data.csv")
white_data  <- read.csv("dataverse_files/white_face_data.csv")
```
...
table_1 <- out.mat[3:nrow(out.mat),1:ncol(out.mat)]
...
print(out.table,
      hline.after = c(0, nrow(out.table)),
      floating = TRUE)
```
